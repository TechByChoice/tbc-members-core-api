...
from apps.company.models import CompanyTypes, SalaryRange, Industries, Roles, Department, Skill, JobLevel
...
class TalentProfile(models.Model):
    ...
    job_level = models.ForeignKey(JobLevel, on_delete=models.CASCADE, related_name='talents_job_level', null=True, blank=True, db_constraint=False)
    skills = models.ManyToManyField(Skill, related_name='talent_skills_list', blank=False)
    department = models.ManyToManyField(Department, related_name='talent_department_list', blank=False)
    ...
    min_compensation = models.ForeignKey(SalaryRange, related_name='min_salary_range', on_delete=models.CASCADE, null=True, blank=True)
    max_compensation = models.ForeignKey(SalaryRange, related_name='max_salary_range', on_delete=models.CASCADE, null=True, blank=True)
