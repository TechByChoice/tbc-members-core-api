    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("ip_address", models.CharField(blank=True, max_length=280, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("ethnicity", models.CharField(max_length=30, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("social_img_url", models.URLField()),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now_add=True)),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("pronouns", models.CharField(max_length=30, unique=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now_add=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("marketing_monthly_newsletter", models.BooleanField(default=False)),
                ("marketing_events", models.BooleanField(default=False)),
                (
                    "marketing_identity_based_programing",
                    models.BooleanField(default=False),
                ),
                ("marketing_jobs", models.BooleanField(default=False)),
                ("marketing_org_updates", models.BooleanField(default=False)),
                (
                    "is_permissions_agree",
                ...
                (
                    "identity_ethic",
                    models.ManyToManyField(blank=True, to="core.ethicidentities"),
                ),
                (
                    "identity_gender",
                    models.ManyToManyField(blank=True, to="core.genderidentities"),
                ),
                (
                    "identity_pronouns",
                    models.ManyToManyField(to="core.pronounsidentities"),
                ),
                (
                    "identity_sexuality",
                    models.ManyToManyField(blank=True, to="core.sexualidentities"),
                ),
                (
                    "member_spotlight",
                    models.ManyToManyField(to="core.membersspotlight"),
                ),
                (
                    "user",
