    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_highlights', django_quill.fields.QuillField(blank=True, null=True)),
                ('company_diversity_statement', django_quill.fields.QuillField(blank=True, null=True)),
                ('company_benefits', django_quill.fields.QuillField(blank=True, null=True)),
                ('company_size', models.CharField(choices=[('1 - 20', '1 - 20'), ('21 - 100', '21 - 100'), ('101 - 500', '101 - 500'), ('501 - 1000', '501 - 1000'), ('1001 - 5000', '1001 - 5000'), ('5001', '5001')], max_length=11)),
                ('is_startup', models.BooleanField(null=True)),
                ('startup_funding_series_stage', models.CharField(blank=True, choices=[('Pre Seed', 'Pre Seed'), ('Seed', 'Seed'), ('Series A', 'Series A'), ('Series B', 'Series B'), ('Series C', 'Series C'), ('Series D', 'Series D'), ('Series E', 'Series E'), ('Series F', 'Series F')], max_length=8, null=True)),
                ('ethics_statement', django_quill.fields.QuillField(blank=True, null=True)),
                ('logo', models.ImageField(default='default-logo.jpeg', upload_to='logo_pics')),
                ('background_img', models.ImageField(default='company_backgrounds/default-background.png', upload_to='company_backgrounds')),
                ...
                ('indigenous_c_level_total', models.IntegerField(blank=True, null=True)),
                ...
                ('career_frameworks_details', django_quill.fields.QuillField(blank=True, null=True)),
                ...
                ('onboarding_plans', django_quill.fields.QuillField(blank=True, null=True)),
                ...
                ('education_budget_total', models.CharField(blank=True, max_length=140, null=True)),
                ...
                ('paid_parental_leave_details', django_quill.fields.QuillField(blank=True, null=True)),
                ...
                ('account_creator', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='profile_as_account_creator', to=settings.AUTH_USER_MODEL)),
                ('account_owner', models.ManyToManyField(related_name='company_account_owner', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=300)),
                ('webflow_item_id', models.CharField(max_length=400)),
                ('skill_type', models.CharField(choices=[('skill', 'skill'), ('tool', 'tool')], default='skill', max_length=5)),
                ('job_roles_wf_id', models.CharField(blank=True, max_length=300, null=True)),
                ('slug', models.CharField(blank=True, max_length=300, null=True)),
                ('job_postings_wf_id', models.CharField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creativity_level', models.CharField(choices=[('light', 'light'), ('medium', 'medium'), ('heavy', 'heavy')], default='light', max_length=10)),
                ('communications_level', models.CharField(choices=[('light', 'light'), ('medium', 'medium'), ('heavy', 'heavy')], default='light', max_length=10)),
                ('independent_work_level', models.CharField(choices=[('light', 'light'), ('medium', 'medium'), ('heavy', 'heavy')], default='light', max_length=10)),
                ('slug', models.CharField(blank=True, max_length=1000, null=True)),
                ('webflow_id', models.CharField(blank=True, max_length=1000, null=True)),
                ('job_post', models.CharField(blank=True, max_length=1000, null=True)),
                ('job_skills', models.CharField(blank=True, max_length=1480, null=True)),
                ('level_of_interaction', models.CharField(choices=[('working_independently', 'working independently'), ('working_as_a_team', 'working as a team')], max_length=25)),
                ('level_of_responsibility', models.CharField(choices=[('light', 'light'), ('medium', 'medium'), ('heavy', 'heavy')], default='light', max_length=25)),
                ('level_of_decision_making', models.CharField(choices=[('light', 'light'), ('medium', 'medium'), ('heavy', 'heavy')], default='light', max_length=25)),
                ('type_of_work', models.CharField(choices=[('creative_work', 'Creative work'), ('logical_work', 'Logical work'), ('analytical_work', 'Analytical work')], default='logical_work', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('changed_at', models.DateTimeField(auto_now=True, null=True)),
                ('job_skill_list', models.ManyToManyField(related_name='role_skills', to='company.skill')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='company.companysubscriptioncodes'),
        ),
        migrations.AddField(
            model_name='companyprofile',
            name='billing_team',
            field=models.ManyToManyField(related_name='company_billing_team', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='companyprofile',
            name='company_types',
            field=models.ManyToManyField(blank=True, related_name='company_types', to='company.companytypes'),
        ),
        migrations.AddField(
            model_name='companyprofile',
            name='current_employees',
            field=models.ManyToManyField(related_name='company_current_employees', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='companyprofile',
            name='hiring_team',
            field=models.ManyToManyField(related_name='company_hiring_team', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='companyprofile',
            name='industries',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='recruiting_for_companies', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='companyprofile',
            name='past_employees',
            field=models.ManyToManyField(related_name='past_companies', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='companyprofile',
            name='referral_employees',
            field=models.ManyToManyField(blank=True, default=[], related_name='company_employees', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='companyprofile',
            name='unclaimed_account_creator',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='profile_as_unclaimed_account_creator', to=settings.AUTH_USER_MODEL),
        ),
    ]
